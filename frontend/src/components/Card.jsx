// import Harry_Potter_B1 from '../assets/book.png'
    ...
    return (
        // <div className="relative">
            <div className='flex flex-shrink-1 relative min-w-96 md:min-w-[450px] mx-4 my-2 rounded-md overflow-hidden hover:scale-105 shadow-md'>
                <div className="flex absolute w-full h-full hover:opacity-0 ease-in-out duration-100 z-20">
                    <img src={props.image} />
                ...
                <div className='bg-blue-600 text-slate-100 w-full p-4 line-clamp'>
                        <p className='p-2 text-xl font-semibold'>#{props.id}. {props.title}</p>
