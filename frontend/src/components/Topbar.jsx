...
function Topbar() {
    return (
        <div className="bg-blue-600 sticky top-0 grid grid-cols-12 w-full h-20 z-50">
           <div className="flex col-span-1 sm:col-span-2 pl-2 sm:pl-10">
                <img className="h-20 w-20 absolute" src={logo}/>
           </div>
            ...
            <div className="flex col-span-1 sm:col-span-2 justify-end">
                <img className="h-10 w-10 my-auto mr-8 rounded-full" src={avatar} />
            </div>
        </div>
    )
}
